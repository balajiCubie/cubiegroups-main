...
import CompanyCardSkeleton from '@/app/components/shared/CompanyCardSkeleton';
  ...
  return (
    <div className={`min-h-screen flex flex-col ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'}`}>
      ...
      <main className="flex-grow">
        {isLoading ? (
          <div className="space-y-12 py-16 container mx-auto px-4">
            <SectionSkeleton /> {/* For Key Investment Highlights */}
            <SectionSkeleton /> {/* For Governance & Strategy */}
            <SectionSkeleton /> {/* For Latest Reports & Filings */}
            ...
            <SectionSkeleton /> {/* For Call to Action */}
            <SectionSkeleton /> {/* For Real-Time Market Data */}
            <SectionSkeleton /> {/* For Proxy Filings, Disclosures & Ethics */}
            <SectionSkeleton /> {/* For Investor Queries */}
            <SectionSkeleton /> {/* For Why Invest in Cubie? */}
          </div>
        ) : (
          <>
